...
export type FreeWatchlistRoute = {
  id: string
  route?: string | null
...
type FreeWatchlistSectionProps = {
  loading: boolean
  watchlist: FreeWatchlistRoute[]
...
export default function FreeWatchlistSection({
  loading,
  watchlist,
  remainingRoutes,
  fadeUp,
