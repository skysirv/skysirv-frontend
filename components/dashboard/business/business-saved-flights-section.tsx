...
type BusinessSavedFlightsSectionProps = {
...
export default function BusinessSavedFlightsSection({
  savedFlights,
  fadeUp,
  onOpenSavedFlightIntelligence,
  onMarkSavedFlightCompleted,
  onDeleteSavedFlight,
}: BusinessSavedFlightsSectionProps) {
  return (
    <motion.section
      {...fadeUp}
        ...
        <div className="mb-8 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 max-w-xl text-sm leading-6 text-slate-600 sm:text-base">
              Save specific flights from your intelligence modal to track price
              changes, trigger alerts, and build your travel history.
            </p>
          </div>
        </div>
