...
export default function Navlinks({ user }: NavlinksProps) {
  ...
  return (
    <div className="pointer-events-auto pt-4 md:pt-5">
      <div className="relative mx-auto flex max-w-7xl items-center justify-between rounded-full border border-slate-200 bg-white px-6 py-3 shadow-[0_12px_30px_rgba(15,23,42,0.10)]">
