...
export default function OnboardingPanel({
  ...
  const asideClassName = isDrawer
    ? "fixed right-0 top-0 z-[70] hidden h-screen w-[440px] xl:block"
    : "fixed right-6 top-20 z-[70] hidden h-[calc(100vh-7.25rem)] w-[420px] xl:block"

  const shellClassName = isDrawer
    ? "relative h-full overflow-hidden border-l border-slate-200 bg-white shadow-[0_28px_90px_rgba(15,23,42,0.14)]"
    : "relative h-full overflow-hidden rounded-[1.85rem] p-[3px] shadow-[0_28px_90px_rgba(15,23,42,0.14)]"

  const cardClassName = isDrawer
    ? "relative flex h-full flex-col overflow-hidden bg-white"
    : "relative flex h-full flex-col overflow-hidden rounded-[calc(1.85rem-3px)] bg-white"
          ...
          <div className={cardClassName}>
            ...
            <div className="flex-1 overflow-y-auto px-5 py-4 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
              <div className="mb-7">
                ...
                <div className="mt-3 space-y-5 text-sm leading-5 text-slate-700">
