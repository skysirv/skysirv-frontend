...
import CruisesResultsPreview from "./CruisesResultsPreview"

export default function CruisesBookingMode({
  config,
  planHandoff,
}: {
  ...
  return (
    <>
      ...
      >
        ...
        <BookingSearchPanel
          onSearch={handleSearchCruises}
          loading={isSearching}
          planHandoff={planHandoff}
        />
      </motion.div>

      {hasSearched && <CruisesResultsPreview />}
    </>
  )
}