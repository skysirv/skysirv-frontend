...
export const MAJOR_AIRPORTS: AirportOption[] = [
    { code: "ATL", city: "Atlanta", name: "Hartsfield-Jackson Atlanta International", country: "USA", region: "GA", displayName: "Hartsfield-Jackson Atlanta Intl Airport" },
    { code: "AUS", city: "Austin", name: "Austin-Bergstrom International", country: "USA", region: "TX", displayName: "Austin-Bergstrom Intl Airport" },
    { code: "BNA", city: "Nashville", name: "Nashville International", country: "USA", region: "TN", displayName: "Nashville Intl Airport" },
    { code: "BOS", city: "Boston", name: "Boston Logan International", country: "USA", region: "MA", displayName: "Boston Logan Intl Airport" },
    { code: "CLT", city: "Charlotte", name: "Charlotte Douglas International", country: "USA", region: "NC", displayName: "Charlotte Douglas Intl Airport" },
    { code: "DCA", city: "Washington", name: "Ronald Reagan Washington National", country: "USA", region: "DC", displayName: "Reagan National Airport" },
    { code: "DEN", city: "Denver", name: "Denver International", country: "USA", region: "CO", displayName: "Denver Intl Airport" },
    { code: "DFW", city: "Dallas", name: "Dallas Fort Worth International", country: "USA", region: "TX", displayName: "Dallas Fort Worth Intl Airport" },
    { code: "DTW", city: "Detroit", name: "Detroit Metropolitan Wayne County", country: "USA", region: "MI", displayName: "Metropolitan Wayne County Airport" },
    { code: "EWR", city: "Newark", name: "Newark Liberty International", country: "USA", region: "NJ", displayName: "Newark Liberty Intl Airport" },
    { code: "FLL", city: "Fort Lauderdale", name: "Fort Lauderdale-Hollywood International", country: "USA", region: "FL", displayName: "Fort Lauderdale-Hollywood Intl Airport" },
    { code: "HNL", city: "Honolulu", name: "Daniel K. Inouye International", country: "USA", region: "HI", displayName: "Daniel K. Inouye Intl Airport" },
    { code: "IAD", city: "Washington", name: "Washington Dulles International", country: "USA", region: "VA", displayName: "Washington Dulles Intl Airport" },
    { code: "IAH", city: "Houston", name: "George Bush Intercontinental", country: "USA", region: "TX", displayName: "George Bush Intercontinental Airport" },
    { code: "JFK", city: "New York", name: "John F. Kennedy International", country: "USA", region: "NY", displayName: "John F. Kennedy Intl Airport" },
    { code: "LAS", city: "Las Vegas", name: "Harry Reid International", country: "USA", region: "NV", displayName: "Harry Reid Intl Airport" },
    { code: "LAX", city: "Los Angeles", name: "Los Angeles International", country: "USA", region: "CA", displayName: "Los Angeles Intl Airport" },
    { code: "LGA", city: "New York", name: "LaGuardia", country: "USA", region: "NY", displayName: "LaGuardia Airport" },
    { code: "MCO", city: "Orlando", name: "Orlando International", country: "USA", region: "FL", displayName: "Orlando Intl Airport" },
    { code: "MDW", city: "Chicago", name: "Chicago Midway International", country: "USA", region: "IL", displayName: "Chicago Midway Intl Airport" },
    { code: "MIA", city: "Miami", name: "Miami International", country: "USA", region: "FL", displayName: "Miami Intl Airport" },
    { code: "MSP", city: "Minneapolis", name: "Minneapolis-Saint Paul International", country: "USA", region: "MN", displayName: "Minneapolis-Saint Paul Intl Airport" },
    { code: "ORD", city: "Chicago", name: "O'Hare International", country: "USA", region: "IL", displayName: "O'Hare Intl Airport" },
    { code: "PDX", city: "Portland", name: "Portland International", country: "USA", region: "OR", displayName: "Portland Intl Airport" },
    { code: "PHL", city: "Philadelphia", name: "Philadelphia International", country: "USA", region: "PA", displayName: "Philadelphia Intl Airport" },
    { code: "PHX", city: "Phoenix", name: "Phoenix Sky Harbor International", country: "USA", region: "AZ", displayName: "Phoenix Sky Harbor Intl Airport" },
    { code: "SAN", city: "San Diego", name: "San Diego International", country: "USA", region: "CA", displayName: "San Diego Intl Airport" },
    { code: "SEA", city: "Seattle", name: "Seattle-Tacoma International", country: "USA", region: "WA", displayName: "Seattle-Tacoma Intl Airport" },
    { code: "SFO", city: "San Francisco", name: "San Francisco International", country: "USA", region: "CA", displayName: "San Francisco Intl Airport" },
    { code: "SJC", city: "San Jose", name: "San Jose Mineta International", country: "USA", region: "CA", displayName: "San Jose Mineta Intl Airport" },
    { code: "SLC", city: "Salt Lake City", name: "Salt Lake City International", country: "USA", region: "UT", displayName: "Salt Lake City Intl Airport" },
    { code: "TPA", city: "Tampa", name: "Tampa International", country: "USA", region: "FL", displayName: "Tampa Intl Airport" },
